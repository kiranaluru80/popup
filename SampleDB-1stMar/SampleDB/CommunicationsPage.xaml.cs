        ...
        public void takePhotoOrAlbumStack( StackLayout visibleOrInvisible, int CategaryId){
            ...
            saveButtoninCategary.Clicked += (sender, e) => {
                ...
                for (int b = 0; b < imageChangeStack.Children.Count; b++)
                {
                    ...
                    if (imageChangeStack.Children[b].StyleId != null)                         {                         if (imageChangeStack.Children[b].StyleId == "SelectedItem")                             {                             StackLayout stackRef = imageChangeStack.Children[b] as StackLayout;                                 Image imageRefffff = stackRef.Children[2] as Image;                             imageRefffff.Source = "ArrowDown";                             }                             if (imageChangeStack.Children[b].IsVisible && imageChangeStack.Children[b].StyleId != "SelectedItem")                                 {                                   imageChangeStack.Children[b].IsVisible = false;                                                         }                         }
